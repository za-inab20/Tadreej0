    ...
    <div className="register-page">
      <Container>
        <Row className="justify-content-center">
          <Col md="6" lg="5">
            <form className="register-card text-center" onSubmit={handleSubmit(onSubmit)}>
              ...
              <FormGroup className="input-wrapper">
                ...
                <input type="text" placeholder="Enter your name ..." className="input-box" {...register('uname')} />
              </FormGroup>
              ...
              <FormGroup className="input-wrapper">
                ...
                <input type="email" placeholder="Enter your email ..." className="input-box" {...register('email')} />
              </FormGroup>
              ...
              <FormGroup className="input-wrapper">
                <select className="input-box" {...register('accountType')}>
