...
export const getUser = createAsyncThunk('users/getUser', async (udata, { rejectWithValue }) => {
  try {
    const response = await api.post('/api/auth/login', udata);
...
export const addUser = createAsyncThunk('users/addUser', async (udata, { rejectWithValue }) => {
  try {
    const response = await api.post('/api/auth/register', udata);
...
export const requestPasswordReset = createAsyncThunk('users/requestPasswordReset', async (email, { rejectWithValue }) => {
  try {
...
export const verifyOtp = createAsyncThunk('users/verifyOtp', async (payload, { rejectWithValue }) => {
  try {
...
export const resetPassword = createAsyncThunk('users/resetPassword', async (payload, { rejectWithValue }) => {
  try {
...
const initVal = {
  ...
  message: '',
  isLoading: false,
  isSuccess: Boolean(storedUser?.email),
  isError: false,
  resetEmail: '',
  resetStatus: 'idle',
  resetMessage: '',
